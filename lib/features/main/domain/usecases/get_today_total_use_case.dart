...
class GetTodayTotalUseCase implements UseCase<AttendanceTimeTotal, NoParams> {
  final MainRepository mainRepository;

  GetTodayTotalUseCase({required this.mainRepository});

  @override
  Future<Either<Failure, AttendanceTimeTotal>> call(NoParams params) async {
    return mainRepository.getTodayTotal();
  }
}
