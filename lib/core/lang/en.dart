class EnLang {
  static Map<String, String> get keys => {
    ...
    'alma_brand_name': 'Alma',
    'workspace_product_name': 'CRM workspace',
    'language_arabic': 'Arabic',
    'language_english': 'English',
    'phone_example_hint': '5XXXXXXX',
    'choose_country': 'Choose country',
    'search_country': 'Search by country or dialing code…',
    ...
    'no_audio_selected': 'No audio file was selected.',
    'clipboard_image_read_failed':
        'Could not read an image from the clipboard.',
    'clipboard_image_prepare_failed': 'Could not prepare the pasted image.',
    'attachment_too_large': 'The file is larger than 10 MB.',
    'invalid_media_url': 'This media link is invalid.',
    'attachment_open_failed': 'Could not open this attachment.',
    'audio_playback_failed': 'Could not play this audio message.',
    'download': 'Download',
    'download_succeeded': 'Downloaded successfully to @path',
    'download_failed': 'Download failed: @error',
    'invalid_download_url': 'The download link is invalid.',
    'download_not_authorized':
        'You are not allowed to download this file (@status).',
    'download_http_failed': 'The download server returned HTTP @status.',
    'unknown_download_error': 'An unexpected error occurred while downloading.',
    'attachments_selected': '@count files selected',
    'remove_all': 'Remove all',
    'emoji': 'Emoji',
    'send_branch_location': 'Send a branch location',
    'media': 'Media',
    ...
    'audio': 'Audio',
    'document': 'Document',
    'select_branch_location': 'Choose a branch location to send',
    'no_company_locations': 'No company locations are available.',
    'session_number': 'Session @id',
    'required_recording_failed':
        'Required call recording could not start: @error',
    'verification_code_sent_whatsapp':
        'The verification code was sent through WhatsApp.',
    'password_changed_successfully': 'Password changed successfully.',
    'no_token_found': 'Your session has expired. Please sign in again.',
