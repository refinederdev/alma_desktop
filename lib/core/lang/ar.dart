class ArLang {
  static Map<String, String> get keys => {
    ...
    'ringing': 'يرنّ…',
    'in_progress': 'مكالمة جارية',
    'call_ended': 'انتهت المكالمة',
    'call_rejected': 'تم رفض المكالمة',
    'call_already_in_progress': 'لديك مكالمة قيد التنفيذ بالفعل.',
    ...
    'no_call_session_hint':
        'تأكد من تفعيل خدمة المكالمات على رقم واتساب أعمال خاصتك.',
    'realtime_connected': 'متصل بالخادم اللحظي',
    'realtime_disconnected': 'غير متصل بالخادم اللحظي',
    'yesterday': 'الأمس',
    'close': 'إغلاق',
    'call_status_completed': 'مكتملة',
    'call_status_rejected': 'مرفوضة',
    'call_status_missed': 'فائتة',
    'call_status_failed': 'فاشلة',
    'call_status_in_progress': 'جارية',
    'call_status_ringing': 'ترن',
    'alma_brand_name': 'ألما',
    'workspace_product_name': 'مساحة عمل إدارة العملاء',
    'language_arabic': 'العربية',
    'language_english': 'الإنجليزية',
    'phone_example_hint': '5XXXXXXX',
    'choose_country': 'اختر الدولة',
    'search_country': 'ابحث باسم الدولة أو رمز الاتصال…',
    ...
    'no_audio_selected': 'لم يتم اختيار ملف صوتي.',
    'clipboard_image_read_failed': 'تعذر قراءة الصورة من الحافظة.',
    'clipboard_image_prepare_failed': 'فشل تجهيز الصورة الملصقة.',
    'attachment_too_large': 'حجم الملف أكبر من 10 ميجابايت.',
    'invalid_media_url': 'رابط الوسائط غير صالح.',
    'attachment_open_failed': 'تعذر فتح هذا المرفق.',
    'audio_playback_failed': 'تعذر تشغيل هذه الرسالة الصوتية.',
    'download': 'تنزيل',
    'download_succeeded': 'تم تنزيل الملف بنجاح إلى @path',
    'download_failed': 'فشل تنزيل الملف: @error',
    'invalid_download_url': 'رابط التنزيل غير صالح.',
    'download_not_authorized': 'غير مسموح لك بتنزيل هذا الملف (@status).',
    'download_http_failed': 'أعاد خادم التنزيل رمز HTTP @status.',
    'unknown_download_error': 'حدث خطأ غير متوقع أثناء التنزيل.',
    'attachments_selected': 'تم تحديد @count ملفات',
    'remove_all': 'إزالة الكل',
    'emoji': 'الرموز التعبيرية',
    'send_branch_location': 'إرسال موقع فرع',
    'media': 'وسائط',
    'paste_image': 'لصق صورة',
    'file': 'ملف',
    'search_emoji': 'ابحث عن رمز تعبيري',
    'image': 'صورة',
    'video': 'فيديو',
    'audio': 'صوت',
    'document': 'مستند',
    'select_branch_location': 'اختر فرعاً لإرسال موقعه',
    'no_company_locations': 'لا توجد فروع متاحة.',
    'session_number': 'الجلسة @id',
    'required_recording_failed': 'تعذر بدء تسجيل المكالمة المطلوب: @error',
    'verification_code_sent_whatsapp': 'تم إرسال رمز التحقق عبر واتساب.',
    'password_changed_successfully': 'تم تغيير كلمة المرور بنجاح.',
    'no_token_found': 'انتهت جلستك. يرجى تسجيل الدخول مرة أخرى.',
